...
class NewsDownloaderTest extends TestCase
{
    ...
    private NewsDuplicateEraser $newsDuplicateEraser;
    ...
    public function setUp(): void
    {
        ...
        $this->newsDuplicateEraser = app(NewsDuplicateEraserInterface::class);
    ...
    public function test_news_download_service()
    {
        ...
        $newsParserMock->shouldReceive('parse')->andReturn([new NewsDTO('test', 'test', 'test', new \DateTime('now'))]);

        $this->newsDownloadService = $this->app->instance(NewsDownloadServiceInterface::class, new NewsDownloadService($newsDownloaderMock, $newsParserMock, $this->newsRepository, $this->newsDuplicateEraser));
    ...
    public function test_news_for_duplicates()
    {
        Event::fake();

        $news1 = new NewsDTO('testDesctiption1', 'testType1', 'testLink1', new \DateTime('2024-04-12 12:59:59'));
        $news2 = new NewsDTO('testDesctiption2', 'testType2', 'testLink2', new \DateTime('2024-04-12 14:59:59'));
        ...
        $arrayForCheckEraser = [
            new NewsDTO('testDesctiption1', 'testType1', 'testLink1', new \DateTime('2024-04-12 16:59:59')),
            new NewsDTO('testDesctiption3', 'testType3', 'testLink3', new \DateTime('2024-04-12 17:59:59')),
        ];

        $arrayWithoutDuplicates = $this->newsDuplicateEraser->newsDuplicateErase($arrayForCheckEraser);

        $this->assertSame('testLink3', $arrayWithoutDuplicates[0]->link);
